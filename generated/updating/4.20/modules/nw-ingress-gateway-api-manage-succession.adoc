...
The updated CRDs must conform to the specific {product-title} specification that is required by the Ingress Operator. {product-title} version 4.20 requires Gateway API Standard version 1.2.1 CRDs.
