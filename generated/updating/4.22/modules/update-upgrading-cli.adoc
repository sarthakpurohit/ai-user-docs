...
Updates to 4.22:
  VERSION               ISSUES
  4.22.0-okd-scos.ec.14 no known issues relevant to this cluster

Updates to 4.21:
  VERSION            ISSUES
  4.21.0-okd-scos.17 no known issues relevant to this cluster
----
endif::openshift-origin[]
+
[NOTE]
...
ip-10-0-168-251.ec2.internal   Ready    master   82m   v1.35.0
ip-10-0-170-223.ec2.internal   Ready    master   82m   v1.35.0
ip-10-0-179-95.ec2.internal    Ready    worker   70m   v1.35.0
ip-10-0-182-134.ec2.internal   Ready    worker   70m   v1.35.0
ip-10-0-211-16.ec2.internal    Ready    master   82m   v1.35.0
