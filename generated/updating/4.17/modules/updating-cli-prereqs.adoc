...
* Review the list of APIs that were removed in Kubernetes 1.30, migrate any affected components to use the new API version, and provide the administrator acknowledgment. For more information, see "Preparing to update to {product-title} 4.17".
