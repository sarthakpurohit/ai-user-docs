...
+
The CVO enforces that updates cannot skip minor versions.
For example, updating directly from 4.17 to 4.19 is blocked; you must first update to 4.18.
The CVO also blocks updates that would cross a major version boundary.
