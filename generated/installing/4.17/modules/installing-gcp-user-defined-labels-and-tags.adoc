...
** Filestore instance resources created by the {gcp-short} filestore CSI driver Operator
** Compute disk and compute image resources created by the {gcp-short} PD CSI driver Operator
