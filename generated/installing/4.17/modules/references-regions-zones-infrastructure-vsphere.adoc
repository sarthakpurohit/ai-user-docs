...
|`vcenters` | The vCenter server for your {product-title} cluster. Currently, only a single vCenter is supported. In Technology Preview, up to 3 vCenter servers are supported.
