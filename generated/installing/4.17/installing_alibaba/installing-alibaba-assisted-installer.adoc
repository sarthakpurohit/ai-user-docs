...
[IMPORTANT]
====
Support for Alibaba Cloud has been deprecated in {product-title} {product-version}. The Alibaba Cloud platform is no longer actively maintained in the Machine API Operator and Machine Config Operator.
====
