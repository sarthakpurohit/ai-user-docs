...
|Selects an initial set of optional capabilities to enable. Valid values are `None`, `v4.11`, `v4.12`, `v4.13`, `v4.14`, `v4.15`, `v4.16`, `v4.17`, `v4.18`, `v4.19`, and `vCurrent`. The default value is `vCurrent`.
|String
